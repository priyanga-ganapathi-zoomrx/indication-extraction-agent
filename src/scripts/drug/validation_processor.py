...
def save_results_csv(
    ...
    extraction_columns = [
        "extraction_primary_drugs",  # JSON array
        "extraction_secondary_drugs",  # JSON array
        "extraction_comparator_drugs",  # JSON array
        "extraction_reasoning"  # JSON array
    ]
    ...
    validation_columns = [
        ...
        "validation_missed_drugs",  # JSON array
        "validation_grounded_search_performed",
        "validation_search_results",  # JSON array
    ...
    for inp, original_row in zip(inputs, original_rows):
        ...
        row["extraction_primary_drugs"] = json.dumps(extraction_result.get("Primary Drugs", []), indent=2, ensure_ascii=False)
        row["extraction_secondary_drugs"] = json.dumps(extraction_result.get("Secondary Drugs", []), indent=2, ensure_ascii=False)
        row["extraction_comparator_drugs"] = json.dumps(extraction_result.get("Comparator Drugs", []), indent=2, ensure_ascii=False)
        row["extraction_reasoning"] = json.dumps(extraction_result.get("Reasoning", []), indent=2, ensure_ascii=False)
        ...
        try:
            ...
            row["validation_confidence"] = validation_data.get("validation_confidence", "")
            row["validation_missed_drugs"] = json.dumps(validation_data.get("missed_drugs", []), indent=2, ensure_ascii=False)
            row["validation_grounded_search_performed"] = validation_data.get("grounded_search_performed", "")
            row["validation_search_results"] = json.dumps(validation_data.get("search_results", []), indent=2, ensure_ascii=False)
