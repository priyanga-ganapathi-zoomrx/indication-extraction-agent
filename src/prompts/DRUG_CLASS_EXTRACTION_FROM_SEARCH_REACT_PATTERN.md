...
Follow this 2-step workflow. The extraction rules are provided in the next message — you MUST read and understand **all 38 rules** before proceeding.
...
* Read and understand **ALL 38 extraction rules**
...
2. **Apply All Applicable Rules to Title-Derived Classes**
   ...
   * Once drug class(es) are identified from the abstract title, pass each extracted class through **all 38 rules**
...
2. **If the Abstract Title Does NOT Contain a Drug Class:**
   ...
   * Read and apply **all 38 rules** while scanning:
...
**Key Principle**: For each extracted drug class, you must consider ALL 38 rules to identify which ones are applicable.
